...
```vue
<template>
  <q-drawer v-bind="$attrs" title="Drawer Title" width="50%"> Drawer Info. </q-drawer>
</template>
<script lang="ts">
  import { defineComponent } from 'vue';
  import { QDrawer } from '@wuefront/vue3-antd-pc-ui';
...
<script lang="ts">
  import { defineComponent } from 'vue';
  import { useDrawer } from '@wuefront/vue3-antd-pc-ui';
...
```tsx
<QDrawer v-bind="$attrs"> Drawer Info. </QDrawer>
```
...
```vue
<template>
  <q-drawer v-bind="$attrs" @register="register" title="Drawer Title" width="50%">
    Drawer Info.
...
<script lang="ts">
  import { defineComponent } from 'vue';
  import { QDrawer, useDrawerInner } from '@wuefront/vue3-antd-pc-ui';
  export default defineComponent({
    components: { QDrawer },
    setup() {
