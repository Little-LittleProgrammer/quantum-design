...
import {QLoading, QThemeModeButton} from '@wuefront/vue3-pc-ui';
...
import { QKeepAliveTabs, QSetting, QBreadcrumb, useProjectSetting, QSearch, QIcon } from '@wuefront/vue3-antd-pc-ui';
