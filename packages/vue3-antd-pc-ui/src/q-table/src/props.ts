...
import type { BasicColumn, FetchSetting, TableSetting, SorterResult, TableCustomRecord, TableRowSelection, SizeType, Recordable, IOptionsTable, BasicTableProps, ExtraComponents } from './types/table';
...
export const basicProps = {
    ...
    virtualConfig: {
        type: Object as PropType<BasicTableProps['virtualConfig']>,
        default: () => ({}),
    },
    ...
    columnsConfig: {
        // 当 columns 为服务端返回时， 自定义 header 属性的
