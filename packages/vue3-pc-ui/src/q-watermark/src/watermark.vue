...
export default defineComponent({
    ...
    setup(props, { slots }) {
        ...
        function listen_css(dom: Node) {
            // 监听元素的css变化
            const _callback: MutationCallback = (mutationsList, observer) => {
                // 监听css变化, 防止去除canvas标签
